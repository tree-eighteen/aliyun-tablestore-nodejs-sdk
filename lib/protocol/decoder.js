...
TableStore.decoder = {
    ...
    decodeAddDefinedColumn: function (buffers) {
        var response = tsProtos.AddDefinedColumnResponse.decode(buffers);
        return response;
    },

    decodeDeleteDefinedColumn: function (buffers) {
        var response = tsProtos.DeleteDefinedColumnResponse.decode(buffers);
        return response;
    },
...
var tsMap = {
    ...
    'addDefinedColumn': TableStore.decoder.decodeAddDefinedColumn,
    'deleteDefinedColumn': TableStore.decoder.decodeDeleteDefinedColumn,
